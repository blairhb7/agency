      ...
      <section className="py-32 md:py-48">
        <div className="container mx-auto px-8">
          ...
          >
            ...
            >
              We are <span className="text-amber-400 font-plaster">AstroLab</span>
            </motion.h1>
            <motion.p
        ...
        <div className="container mx-auto px-8">
          ...
          >
            ...
            <div className="space-y-8 font-bebas">
              {[
                "Founded in 2019, DesignCraft began as a small studio with a big vision: to bridge the gap between beautiful design and meaningful business results. What started as a two-person team has grown into a collective of creative minds, each bringing unique expertise to every project.",
                ...
                "Today, we’re proud to have helped over 150 companies across various industries tell their stories through exceptional digital experiences. From startups to Fortune 500 companies, we’ve learned that the best solutions come from truly understanding our clients’ challenges and aspirations.",
              ].map((text, i) => (
                <motion.p
                  key={i}
